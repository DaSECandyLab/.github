...
<img width="627" height="627" alt="ChatGPT Image May 5, 2026, 03_33_44 PM" src="https://github.com/user-attachments/assets/a67353e1-1367-4452-b325-fba79a067f93" />
...
- **2024:** L Chen (Master-->ECNU Phd), ~R Chen (Master-->Walking Dead)~, H Wang (Master-->ByteDance SSP), X Xiong (Master-->BYD), Q Wang (Phd--> Tencent Game SSP, cosupervised with Prof. R Zhang), K Li(Phd-->Assistant Professor in Fuzhou University, cosupervised with Prof. R Zhang).
